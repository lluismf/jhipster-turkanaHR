...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().type(DEFAULT_TYPE).value(DEFAULT_VALUE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().type(UPDATED_TYPE).value(UPDATED_VALUE);
        return contact;
    }
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.type(UPDATED_TYPE).value(UPDATED_VALUE);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.type(UPDATED_TYPE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.type(UPDATED_TYPE).value(UPDATED_VALUE);
