...
type ContactFormGroupContent = {
  ...
  value: FormControl<IContact['value']>;
  employee: FormControl<IContact['employee']>;
};
...
export class ContactFormService {
  createContactFormGroup(contact: ContactFormGroupInput = { id: null }): ContactFormGroup {
    ...
    return new FormGroup<ContactFormGroupContent>({
      ...
      value: new FormControl(contactRawValue.value),
      employee: new FormControl(contactRawValue.employee),
    });
  }
